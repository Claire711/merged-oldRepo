            ...
            <el-col :span="14">
                <el-card class="entrance-card">
                    ...
                    <div class="button-group">
                        <div class="button-item" v-for="item in entranceList" :key="item.name">
                            <el-button :type="item.type" :icon="item.icon" plain @click="handleClick(item)" />
                            {{ item.title }}
                        </div>
                    </div>
                </el-card>
                <el-card class="chart-card">
                    ...
                    <div class="time-select">
                        <el-select @change="getChartInfo" v-model="userChartRequest.date" placeholder="Select"
                            style="width:200px">
                            <!--    :key="item.value" 唯一标识 
                                :label="item.label"  显示文本 
                                :value="item.value"  实际值  -->
                            <el-option v-for="item in userChartOptions"
                             :key="item.value"
                                :label="item.label"
                                :value="item.value" 
                                />
                ...
                <el-card class="aside">
                    ...
                    <div class="text">
                        <el-text>
                            ...
                            邮箱：[{{ websiteStore.state.websiteInfo.email }}]<br>
...
import { userChart, userWeather, type UserChartRequest, type UserChartResponse } from '@/api/user';
