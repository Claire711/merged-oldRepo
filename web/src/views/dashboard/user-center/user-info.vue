    ...
    <div class="user-info">
        <el-col :span="12">
            <div class="info">
                ...
                <div class="content">
                    <el-form ref="userChangeInfoForm" :model="userChangeInfoFormData" :rules="rules" 
                    :validate-on-rule-change="false" hide-required-asterisk label-width="auto" style="max-width:400px">
                        ...
                        <el-form-item label="签名" prop="signature">
                            <el-input @change="updateUserInfo" v-model="userChangeInfoFormData.signature"
