                        ...
                        <div class="operation">
                            <div class="comment-tool">
                                <el-popover width="502" trigger="click">
                                    ...
                                    <template #default>
                                        <el-image v-for="number in numbers"
                ...
                <el-aside>
                    <div class="aside-content">
                        <div class="catalog">
                            ...
                            <!-- <MdCatalog> 是一个封装好的自定义组件，作用是根据 Markdown 内容中的标题
                                （如 # 一级标题、## 二级标题 等）自动生成目录，点击目录项可以快速跳转到对应标题位置，实现文档内的锚点导航。 -->
                            <MdCatalog :editorId="mdID" :scrollElement="scrollElement" :offsetTop="100"
