...
// /config: AxiosRequestConfig 表示：请求拦截器接收的参数 config（即请求配置对象）的类型是 AxiosRequestConfig。
...
//虽然我声明 config 是 AxiosRequestConfig 类型，但经过处理后，它实际上符合 InternalAxiosRequestConfig 类型，请按照这个类型处理        
