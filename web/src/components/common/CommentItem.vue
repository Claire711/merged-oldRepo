      ...
      <div class="item-card">
        ...
        <div class="footer">
          <div class="button-group">
            ...
            <el-button
              v-if="(item.user_uuid === userStore.state.userInfo.uuid || userStore.isAdmin) && !(replyFlag === item.id)"
              type="danger" @click="handleDelete(item.id)">
              删除
            </el-button>
          </div>
        </div>
        <div v-if="replyFlag === item.id" class="reply">
          ...
          <div class="comment-tool">
            <el-popover width="502" trigger="click">
              ...
              <template #default>
                <el-image v-for="number in numbers" :src="'/emoji/xiaochun_emoji_' + number + '.png'"
...
const content = ref('')
// 生成一个包含 50 个元素的响应式数组，元素为 "01" 到 "50" 的字符串
