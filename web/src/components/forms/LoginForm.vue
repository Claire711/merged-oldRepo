<template>
    <div class="login-form">
        <el-image class="login-image" src="/image/butterfly_ambassador3_right.png" alt="" />
        <el-form ref="loginForm" :model="loginFormData" :rules="rules" :validate-on-rule-change="false"
            ...
            <el-form-item label="邮箱" prop="email">
                <el-input v-model="loginFormData.email" size="large" placeholder="请输入邮箱" suffix-icon="user" />
            </el-form-item>
            ...
            <el-form-item>
                <el-button type="primary" size="large" @click="submitForm">登 录
                </el-button>
            </el-form-item>
        </el-form>
    </div>
