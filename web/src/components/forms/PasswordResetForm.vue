<template>
  <div class="password-reset-form">
    <el-form ref="passwordResetForm" :model="passwordResetFormData" :rules="rules" :validate-on-rule-change="false"
      hide-required-asterisk>
      <el-form-item label="原密码" prop="password">
        <el-input v-model="passwordResetFormData.password" size="large" placeholder="请输入旧密码" />
      </el-form-item>

      <el-form-item label="新密码" prop="new_password">
        <el-input v-model="passwordResetFormData.new_password" size="large" placeholder="请输入新密码" />
      </el-form-item>
      ...
      <el-form-item>
        <div class="button-group">
          ...
          <el-button size="large" @click="layoutStore.state.passwordResetVisible = false">取消
          </el-button>
        </div>
      </el-form-item>
    </el-form>
