...
func (websiteService *WebsiteService) WebsiteFooterLink() []database.FootLink {
	var footLinks []database.FootLink
	global.DB.Find(&footLinks)
	return footLinks
}
...
func (websiteService *WebsiteService) WebsiteCreateFooterLink(req database.FootLink) error {
	return global.DB.Save(&req).Error
}
func (websiteService *WebsiteService) WebsiteDeleteFooterLink(req database.FootLink) error {
